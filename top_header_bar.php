 ...
 <header class="top-header-bar-container">
     <div class="container-fluid px-3">
         <ul class="d-flex justify-content-between top-header-bar">
             <!-- Logo -->
             <li class="header-logo align-self-center">
                 <a href="home.php" class="custom-logo-link" rel="home" aria-current="page"><img width="100" height="70" src="wp-contents/uploads/sites/64/2017/06/logo.png" class="custom-logo" alt="Tyche Demo" /></a>
             </li>
             <!-- / Logo -->
             <!-- Email -->
             <!-- <li class="top-email">
             ...
             <!-- nav-menu -->
             <li class="align-self-center flex-fill">
                 <nav class="navbar">
                     <div class="text-center align-self-center">
                         <ul id="desktop-menu" class="sf-menu  text-center">
                 ...
                 <ul class="d-flex justify-content-end">
                     ...
                     <?php } else { ?>
                         ...
                         <li class="top-new-user ">
                             <a href="new-user-register.php" class=" top-header-bar__white-border-btn"><i class="fa fa-user-plus"></i> New User</a>
                         </li>
                         <!-- / New user -->
