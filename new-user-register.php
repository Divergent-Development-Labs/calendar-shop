                                ...
                                <div class="woocommerce-billing-fields__field-wrapper">
                                    <form action="backend/insert-new-user.php" method="post">
                                        <div class="">
                                            ...
                                            <div class="mt-4  form-row-wide validate-required validate-phone" id="user_phone_field" data-priority="100">
                                            ...
                                            <div class="mt-4 form-row-wide validate-required validate-email" id="user_email_field" data-priority="110">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class=" ">
                                                <div class=" form-row-firstz validate-required" id="user_first_name_field" data-priority="10">
                                                    <span class="woocommerce-input-wrapper">
                                                ...
                                                <div class="mt-2  address-field form-row-wide" id="user_address_2_field" data-priority="60">
                                                    <span class="woocommerce-input-wrapper">
                                        ...
                                        <div class=" mt-4">
                                            <div class=" address-field validate-required form-row-wide" id="user_city_field" data-priority="70">
                                            ...
                                            <div class="mt-4  address-field validate-required validate-state form-row-wide" id="user_state_field" data-priority="80" data-o_class="form-row-wide address-field validate-required validate-state">
                                            ...
                                            <div class="mt-4  address-field validate-required validate-postcode form-row-wide" id="user_postcode_field" data-priority="90" data-o_class="form-row-wide address-field validate-required validate-postcode">
                                        ...
                                        <div class="my-4 text-center">
                                            <button type="submit" class="btn-my-primary alt" id="new_user" name="register_btn" data-value="Place order">Register</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
