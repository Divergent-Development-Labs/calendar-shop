					...
					<div class="col-md-9 tyche-has-sidebar">
						<div class="row">
							<ul class="nav nav-tabs col-sm-5 border-0">
								<li class="">
									<h5 class="text-dark">
										<a href="#designs" data="default" data-toggle="tab" aria-expanded="false" class="nav-link design-tab">Designs</a>
										<h5>
								</li>
								<li class="" <?php echo ($userId != null) ? $userId : 'hidden'; ?>>
									<h5>
										<a href="#customDesigns" data="custom" data-toggle="tab" aria-expanded="false" class="nav-link design-tab">Custom</a>
										<h5>
								</li>
							</ul>
