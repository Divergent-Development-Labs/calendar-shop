	...
	<div id="page" class="site">
		...
		<div class="site-content">
			...
			<div class="container-fluidz ">
				<div class="row">
					<div class="col-xs-12">
						<h2 class="custom-page-title">Our Services</h2>
					</div>
				</div>

				<section class=" our-service-section our-service-section__default">
					<a  id="PVC-Manufacturing" class="row">
						<div class="col-lg-6 col-12 our-service-content">
							<h2 class="our-service-section__h2">PVC Manufacturing:</h2>
				...
				<section class=" our-service-section our-service-section__default">
					<a  id="Offset-Printing" class="row">
						<div class="col-lg-6 col-12 our-service-content">
							<h2 class="our-service-section__h2" >Offset Printing:</h2>
				...
				<section class=" our-service-section our-service-section__default">
					<a  id="NoteBooks" class="row">
						<div class="col-lg-6 col-12 our-service-content">
							<h2 class="our-service-section__h2" >Note Books:</h2>
