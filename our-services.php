...
<head>
	<?php session_start(); ?>	
	<title>Our Services - Tyche Demo</title>
	...
	<div id="page" class="site">
		...
		<div class="site-content">
			...
			<div class="container-fluid">
				<div class="row mb-4">
					<div class="col-sm-6">
						<h4>PVC Manufacturing:</h4>
						<p>PVC LaminationFlim (5 to10 Microns) with width from 75mm to 990 mm. Our films are widely used in lamination of cartons for pharmaceuticals, cosmetics, toiletries, readymade garments and hosiery. Wrappers for books and confectionery, detergent cakes, soaps, posters, corrugated boxes for electronic appliances, gift articles, consumers products and window envelopes.</p>
					</div>
					<div class="col-sm-6">
				...
				<div class="row mb-4">
					...
					<div class="col-sm-6">
						...
						<p>Packaging is the face of your product, technology of enclosing or protecting products for distribution, storage, sale, and use. We PadmaavathyArtCrafts are expert in manufacturing of Cosmetic Box, Pharmaceutical box, Sweet Box and printed carton box</p>
					</div>
				</div>                                                         
			</div>
		</div><!-- #content -->
