	...
	<div id="page" class="site">
		...
		<div class="site-content">
			<div class="container-fluid">
				<div class="row">
					<div class="col-xs-12">
						<div class="tyche-breadcrumbs"><span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="home.php"><span itemprop="title">Home </span></a></span><span class="tyche-breadcrumb-sep">/</span><span class="breadcrumb-leaf">Our Products</span></div>
					</div>
				</div>
			</div>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-xs-12">
						<h2 class="custom-page-title text-center mb-5">Our Products</h2>
					</div>
				</div>

				<div class=" mb-4 our-products-div">
					<a  id="PVC-Laminatation-Flim" class="row">
				...
				<div class="mb-4 our-products-div">
					<a  id="Monthly-Calendar" class="row d-block">
				...
				<div class=" mb-4 our-products-div">
					<a  id="Daily-Calendar-Slip" class="row">
						<div class="col-lg-6 col-12">
				...
				<div class=" mb-4 our-products-div">
					<a  id="Daily-Calendar" class="row d-block">
						<div class="col-lg-6 col-12 float-right">
				...
				<div class=" mb-4 our-products-div">
					<a  id="Die-Cut-Calendar" class="row">
						<div class="col-lg-6 col-12">
				...
				<div class=" mb-4 our-products-div">
					<a  id="Table-Calendar" class="row d-block">
						<div class="col-lg-6 col-12 float-right">
