	...
	<div id="page" class="site">
		...
		<div class="site-content">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						<div class="tyche-breadcrumbs"><span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="https://demo.colorlib.com/tyche"><span itemprop="title">Home </span></a></span><span class="tyche-breadcrumb-sep">/</span><span class="breadcrumb-leaf">Contact</span></div>
					</div>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<div class="tyche-icon-box">
									...
									<div class="text">
										GIVE US A CALL <span>0123456789</span>
									</div>
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
								<div class="tyche-icon-box">
									...
									<div class="text">
										OUR LOCATION <span>New York City Hall, NY 10007, USA</span>
									</div>
								</div>
							</div>
						</div>
